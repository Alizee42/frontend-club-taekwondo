...
export interface Commande {
  id?: number;
  statut?: string;        // EN_ATTENTE, PAYEE, ANNULEE, RETIREE, ...
...
export class CommandeService {
  ...
  creerCommandeAvecLignes(commandeDTO: any): Observable<Commande> {
    return this.http.post<Commande>(`${this.apiUrl}/with-lignes`, commandeDTO, { headers: this.jsonHeaders })
      .pipe(catchError(this.handleError));
  }

  /** 🔹 Créer une commande en attente */
  creerCommandeEnAttente(commandeDTO: any): Observable<Commande> {
  ...
  /** 🔹 Récupérer un utilisateur lié à une commande */
